...
const Form = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const text = `Hello, my name is ${name}.%0AEmail: ${email}%0ALocation: ${location}%0ABudget: ${budget}%0ASubject: ${subject}%0AMessage: ${message}`;
    const phoneNumber = "254105379207";
  ...
  return (
    <div>
      <p className="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-soft-dark">
        I'm always open to discussing project development work or partnership
        opportunities.
      </p>
      <div className="mx-2">
